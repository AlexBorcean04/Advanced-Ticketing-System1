    ...
    <div className="max-w-4xl mx-auto px-6 py-16">
      <div className="glass-panel rounded-3xl p-8 md:p-12 max-w-lg mx-auto">
        <div className="space-y-3 mb-8">
          <p className="text-xs uppercase tracking-[0.3em] text-accent-500/80">Welcome back</p>
          <h1 className="text-3xl font-semibold">Log in to hold seats</h1>
          <p className="text-white/60">
            Access your account to checkout and confirm bookings.
          </p>
        </div>
        ...
        <p className="text-sm text-white/60 mt-6">
          New here?{' '}
          <Link className="text-accent-500 hover:text-accent-400" to="/register">
            Create an account
          </Link>
          .
        </p>
